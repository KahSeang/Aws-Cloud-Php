...
<div class="content">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $event_id); ?>" method="POST" enctype="multipart/form-data" class="edit-event-form">
        ...
        <input type="text" id="type_name" name="type_name" value="<?php echo htmlspecialchars($type_name); ?>" required><br><br>
        ...
        <input type="text" id="category_id" name="category_id" value="<?php echo htmlspecialchars($category_id); ?>" required><br><br>

        <label for="available">Available:</label>
        <input type="number" id="available" name="available" value="<?php echo htmlspecialchars($available); ?>" required><br><br>
        ...
        <label for="main_image">Main Product Image Path:</label>

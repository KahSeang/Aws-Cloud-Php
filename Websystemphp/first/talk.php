...
<section class="slider_section">
  <div class="container2">
    <div class="top_boxes">
      <div class="box">
        <a href="desc.php" class="image-link">
          <img src="desc.jpg" alt="basketball">
      ...
      <div class="box">
        <a href="watch.php" class="image-link">
          <img src="watch.jpg" alt="swimming">
          <div class="text-overlay">
            <p>Watch talk</p>
            <span class="learn-more-button">Learn More</span>
          </div>
    ...
    <div class="bottom_boxes">
      <div class="box">
        <a href="participate.php" class="image-link">
          <img src="participate.jpg" alt="pingpong">
          <div class="text-overlay">
            <p>Join the Event</p>
            <span class="learn-more-button">Learn More</span>
          </div>
      ...
      <div class="box">
        <a href="QNA.php" class="image-link">
          <img src="qna.jpg" alt="volleyball">
          <div class="text-overlay">
            <p>Any Question?</p>
            <span class="learn-more-button">Learn More</span>
          </div>

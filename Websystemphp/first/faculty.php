...
<section class="slider_section">
  <div class="container2">
    <div class="top_boxes">
      <div class="box">
          ...
          <div class="text-overlay">
            <p>The key to being a great basketball player is to never stop learning and to always be willing to get better.</p>
            <a href="basketball.php" class="image-link"><span class="learn-more-button">Learn More</span></a>
          </div>
        
      </div>
      <div class="box">
        <a href="swimming.php" class="image-link">
          <img src="swimming.jpg" alt="swimming">
          <div class="text-overlay">
            <p>Swimming is not just a sport; it's a way to escape, to breath, to find a piece in the chaos of life.</p>
    ...
    <div class="bottom_boxes">
      <div class="box">
        <a href="pingpong.php" class="image-link">
          <img src="table_tennis.jpg" alt="pingpong">
          <div class="text-overlay">
            <p>Be like a ping pong ball; the harder they throw you, the higher you rise.</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>
      <div class="box">
        <a href="volleyball.php" class="image-link">
          <img src="volleyball.jpg" alt="volleyball">
          <div class="text-overlay">
            <p>Is just a more intense version of: Don't Let the BALLOON Hit the Floor.</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>

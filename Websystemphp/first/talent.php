...
<section class="slider_section">
  <div class="container2">
    <div class="top_boxes">
      <div class="box">
        <a href="singing.php" class="image-link">
          <img src="singing.jpg" alt="basketball">
      ...
      <div class="box">
        <a href="dancing.php" class="image-link">
          <img src="dancing.jpg" alt="swimming">
          <div class="text-overlay">
            <p>Dance is a art, point your dream and follow it.</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>
    ...
    <div class="bottom_boxes">
      <div class="box">
        <a href="draw.php" class="image-link">
          <img src="draw.jpg" alt="pingpong">
          <div class="text-overlay">
      ...
      <div class="box">
        <a href="photo.php" class="image-link">
          <img src="photo.jpg" alt="volleyball">
          <div class="text-overlay">
            <p>Life is FULL of beautiful moment, REMEMBER THEM.</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>

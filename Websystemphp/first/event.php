...
<section class="slider_section">
  <div class="container2">
    <div class="top_boxes">
      <div class="box">
        <a href="raya.php" class="image-link">
          <img src="raya.jpg" alt="basketball">
          <div class="text-overlay">
            <p>May the blessings of Allah fill your heart & soul</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>
      <div class="box">
        <a href="food_festival.php" class="image-link">
          <img src="food_festival.jpg" alt="swimming">
          <div class="text-overlay">
            <p>Food bring people together</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>
    ...
    <div class="bottom_boxes">
      <div class="box">
        <a href="cleanup.php" class="image-link">
          <img src="cleanup.jpg" alt="pingpong">
          <div class="text-overlay">
            <p>Be a part of solution; NOT part of the POLLUTION</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>
      <div class="box">
        <a href="tourist.php" class="image-link">
          <img src="tourist.jpg" alt="volleyball">
          <div class="text-overlay">
            <p>Travel not to find yourself, but to remember who you've been all along</p>
            <span class="learn-more-button">Learn More</span>
          </div>
        </a>
      </div>

...
<html>
    ...
    <body>
        ...
        <div class="hero_area">
            <img src="<?php echo isset($row_home['home_poster']) ? $row_home['home_poster'] : ''; ?>" style="display:inline-block;width: 100%;opacity: 1.5;max-height: 700px;position:relative;">
        ...
        <div class="content-area">
            <h1 style="text-align: center;
                font-size: 36px;
                color: #333;
                margin-bottom: 20px">Our Products</h1>
